...
#function for extrracting email and password
def emailExtract():
    path = 'C:\\Users\\rohit\\OneDrive\\Documents\\emailDetails'
...
if __name__ == "__main__":
    ...
    while True:
        ...
        #for playing music from local directory
            ...
            music_dir = 'C:\\Users\\rohit\\Music\\Sample Music'
            ...
            whatsappPath = 'C:\\Users\\rohit\\AppData\\Local\\WhatsApp\\WhatsApp.exe' 
            ...
            try:
                ...
                speak('Sir, The email has been sent to Mr. Rohit.')
            except Exception as e:
                print(e)
            ...
            try:
                ...
                sendEmail(to, content)
                speak('Sir, The email has been sent to Mr. Shivam.')
            except Exception as e:
                print(e)
                speak('Sorry Sir! i am not able to send this email at the moment. Please try after some time.')
